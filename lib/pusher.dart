...
class Pusher {
  ...
  static const _channel = const MethodChannel('plugins.indoor.solutions/pusher');
  static const _eventChannel = const EventChannel('plugins.indoor.solutions/pusherStream');

  static void Function(ConnectionStateChange)? _onConnectionStateChange;
  static void Function(ConnectionError)? _onError;

  static Map<String, void Function(Event)?> eventCallbacks = <String, void Function(Event)?>{};
  ...
  static Future _trigger(String channelName, String eventName, String data) async {
